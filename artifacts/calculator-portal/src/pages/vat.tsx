  ...
  return (
    ...
    >
      <div className="flex items-center gap-3 mb-8">
        ...
        <div>
          <h1 className="text-3xl font-bold tracking-tight">{t.vat.title}</h1>
          <p className="text-muted-foreground">{t.vat.subtitle}</p>
        </div>
      </div>

      <div className="mb-6 space-y-3">
        <Label className="text-xs uppercase tracking-wider font-bold text-muted-foreground">{t.vat.selectRate}</Label>
        <div className="flex flex-wrap items-center gap-2">
          ...
          <div className="relative ml-2 w-24">
            <Input
              type="number" min="0" step="0.1" value={vatRate}
      ...
      <Tabs defaultValue="add-vat" className="w-full">
        <TabsList className="grid w-full grid-cols-2 mb-6">
          <TabsTrigger value="add-vat">{t.vat.addVat}</TabsTrigger>
          <TabsTrigger value="extract-vat">{t.vat.extractVat}</TabsTrigger>
        </TabsList>
